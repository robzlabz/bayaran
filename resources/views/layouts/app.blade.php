...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div x-data="{ sidebarOpen: false, isDark: document.documentElement.classList.contains('dark') }" class="min-h-screen bg-gray-100 dark:bg-gray-900 lg:flex">
            ...
            <!-- Sidebar -->
            <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:inset-auto"
                ...
                <div class="flex flex-col h-full">
                    ...
                    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                        ...
                        {{-- ── OWNER MENU ── --}}
                        @if($user->isOwner())
                            <p class="px-3 pb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Menu</p>
                            ...
                            <x-nav-link :href="route('company.debts.index')" :active="request()->routeIs('company.debts.*')">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <x-nav-link :href="route('company.attendances.index')" :active="request()->routeIs('company.attendances.*')">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                                </svg>
                                <span>Absensi</span>
                            </x-nav-link>
                            <x-nav-link :href="route('company.leaves.index')" :active="request()->routeIs('company.leaves.*')">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {{-- ── EMPLOYEE MENU ── --}}
                        @if($user->isEmployee())
                            <p class="px-3 pb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Absensi</p>
                        ...
                        @if($user->isSuperAdmin())
                            <p class="px-3 pb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Admin</p>
                    ...
                    <div class="p-4 border-t border-gray-200 dark:border-gray-700 shrink-0">
                        <div class="flex items-center gap-3 px-3 py-2 text-sm text-gray-600 dark:text-gray-400">
                            <div class="w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center text-indigo-600 dark:text-indigo-300 font-semibold shrink-0">
                        ...
                        <div class="mt-2 space-y-1">
                            <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition">
            ...
            <div class="flex-1 flex flex-col min-w-0">
                ...
                <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 lg:hidden">
                    <div class="flex items-center justify-between h-16 px-4">
                        <button @@click="sidebarOpen = true" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @isset($header)
                    <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                            ...
                            <button @@click="isDark = !isDark; document.documentElement.classList.toggle('dark'); localStorage.setItem('darkMode', isDark)" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition shrink-0" title="Toggle mode">
